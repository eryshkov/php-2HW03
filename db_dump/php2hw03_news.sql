...
INSERT INTO php2hw03.news (title, content, author_id) VALUES ('Кибермошенники украли одну из крупнейших групп в «Одноклассниках»', 'Житель Москвы обратился в полицию из-за украденной группы в «Одноклассниках». Об этом он во вторник, 5 марта, рассказал «Ленте.ру».
...
INSERT INTO php2hw03.news (title, content, author_id) VALUES ('Венесуэла выдворила европейского посла', 'Министерство иностранных дел Венесуэлы объявило посла Германии в Каракасе Даниэля Кринера персоной нон-грата. Об этом сообщает «Интерфакс» в среду, 6 марта.', 2);
